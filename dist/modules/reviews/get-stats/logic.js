...
exports.GetReviewsStatsLogic = void 0;
const review_model_1 = __importDefault(require("../review.model"));
const input_1 = require("./input");
class GetReviewsStatsLogic {
    constructor() { }
    async get(input, language = "en") {
        const { query } = input_1.inputSchema.parse(input);
        const { item } = query;
        const reviewsDetails = await review_model_1.default.aggregate([
            {
                $match: {
                    item: item,
                },
        ...
        const response = reviewsDetails[0];
        ...
        response.ratingBreakdown = response.ratingBreakdown.sort((a, b) => a.rating - b.rating);
        return response;
    }
}
exports.GetReviewsStatsLogic = GetReviewsStatsLogic;
