...
exports.aggregateVariantList = exports.aggregateVariantDetails = exports.aggregateProductDetails = void 0;
const aggregations_1 = require("../../../../../shared/utils/aggregations");
const aggregateProductDetails = (language = "en") => {
    const queries = [
        ...(0, aggregations_1.imageAggregate)("images", false),
        ...(0, aggregations_1.unwindQuery)("installmentOptions", true),
        ...(0, aggregations_1.imageAggregate)("installmentOptions.contract"),
        {
            $set: {
        ...
        ...(0, aggregations_1.unwindQuery)("category", true),
    ];
    if (language === "en") {
        queries.push({
            $project: {
...
exports.aggregateProductDetails = aggregateProductDetails;
const aggregateVariantDetails = (language = "en") => {
    const projection = [];
    if (language === "en") {
        projection.push({
            $project: {
...
const aggregateVariantList = (language = "en") => {
    const projection = [];
    if (language === "en") {
        projection.push({
            $project: {
...
exports.aggregateVariantList = aggregateVariantList;
