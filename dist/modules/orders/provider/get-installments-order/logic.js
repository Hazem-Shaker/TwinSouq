...
exports.GetInstallmentsOrderForProviderLogic = void 0;
...
class GetInstallmentsOrderForProviderLogic {
    constructor() { }
    async execute(input, language = "en") {
        const { provider, id } = input_1.inputSchema.parse(input);
...
exports.GetInstallmentsOrderForProviderLogic = GetInstallmentsOrderForProviderLogic;
