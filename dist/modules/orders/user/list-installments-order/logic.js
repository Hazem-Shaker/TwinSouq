...
class ListInstallmentsOrderForUserLogic {
    ...
    async list(input, language = "en") {
        ...
        const orders = await installmentsOrder_model_1.default.aggregate([
            {
                $match: matchQuery,
            },
            { $sort: { createdAt: -1 } },
        ...
        const totalCount = await installmentsOrder_model_1.default.countDocuments(matchQuery);
...
exports.ListInstallmentsOrderForUserLogic = ListInstallmentsOrderForUserLogic;
