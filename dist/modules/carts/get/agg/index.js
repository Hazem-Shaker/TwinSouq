...
exports.aggregateForOrder = exports.aggregateCartDetails = exports.aggregateVariantDetails = exports.productData = void 0;
const aggregations_1 = require("../../../../shared/utils/aggregations");
const productData = (language = "en", forOrder = false) => {
    const projection = [];
...
const aggregateVariantDetails = (language = "en", forOrder = false) => {
    const projection = [];
    if (!forOrder && language === "en") {
        projection.push({
            $project: {
...
exports.aggregateVariantDetails = aggregateVariantDetails;
const aggregateCartDetails = (language = "en", forOrder = false) => {
    const agg = [
        {
            $unwind: {
                path: "$products",
        ...
        },
        {
            $lookup: {
                ...
                foreignField: "_id",
                as: "products.product",
                pipeline: [...(0, exports.productData)(language, forOrder)],
            },
        },
        {
            $unwind: {
        ...
        },
        {
            $lookup: {
                ...
                foreignField: "_id",
                as: "products.variant",
                pipeline: [...(0, exports.aggregateVariantDetails)(language, forOrder)],
            },
        },
        {
            $unwind: {
...
exports.aggregateCartDetails = aggregateCartDetails;
const aggregateForOrder = () => {
    return (0, exports.aggregateCartDetails)("en", true);
};
exports.aggregateForOrder = aggregateForOrder;
