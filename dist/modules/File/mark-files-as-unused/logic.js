...
exports.MarkFileAsUnusedLogic = void 0;
const custom_errors_1 = require("../../../shared/utils/custom-errors");
const file_model_1 = __importDefault(require("../file.model"));
const input_1 = require("./input");
class MarkFileAsUnusedLogic {
    async markFilesAsUnused(data, session) {
        ...
        return "Files marked as unused";
    }
}
exports.MarkFileAsUnusedLogic = MarkFileAsUnusedLogic;
