...
10. [Responses & errors](#responses--errors)
11. [Background jobs (Agenda)](#background-jobs-agenda)
12. [Payment & checkout status](#payment--checkout-status)
13. [Logging & uploads](#logging--uploads)
